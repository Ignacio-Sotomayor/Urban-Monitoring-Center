    ...
    private void searchFines() {
        ...
        try {
            ...
            if (fines.isEmpty()) {
                ...
                for (Fine f : fines) {
                    String speed = (f instanceof com.model.Fines.ExcessiveSpeedFine esf) ? String.valueOf(esf.getAutomobileSpeed()) : "-";
                    String limit = (f instanceof com.model.Fines.ExcessiveSpeedFine esf) ? String.valueOf(esf.getSpeedLimit()) : "-";
