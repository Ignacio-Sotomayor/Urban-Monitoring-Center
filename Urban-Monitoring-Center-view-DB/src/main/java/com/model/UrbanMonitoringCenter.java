...
public class UrbanMonitoringCenter {
    ...
    public void repairToIntermittent(Device d) {
        if (d instanceof TrafficLightController) {
            repairDevices(d); // First, do a normal repair
    ...
    public void setFatalError(Device device) {
        if (device != null && !isFatalError(device)) {
            ...
            issuedDevices(device); // A fatal device is also inoperative
            failureRecords.add(new FailureRecord(device, "ERROR FATAL"));
        }
    }

    public boolean isFatalError(Device device) {
        return device != null && this.fatalErrorDevices.contains(device.getId());
    }
   ...
   /* public void informAllSecurityNotices(){
    ...
    public static void loadDevices(){
        ...
        tf = new TrafficLightController("Av. Independencia 2500",new Location(BigDecimal.valueOf(-38.002863),BigDecimal.valueOf(-57.558199)),true, new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Gascon",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 2400",new Location(BigDecimal.valueOf(-38.002053),BigDecimal.valueOf(-57.557535)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Falucho",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 2300",new Location(BigDecimal.valueOf(-38.001261),BigDecimal.valueOf(-57.556904)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Almirante Brown",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia, Av. Colon",new Location(BigDecimal.valueOf(-38.000394),BigDecimal.valueOf(-57.556213)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Av. Colon",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 2100",new Location(BigDecimal.valueOf(-37.999542),BigDecimal.valueOf(-57.555559)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Bolivar",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 2000",new Location(BigDecimal.valueOf(-37.998758),BigDecimal.valueOf(-57.554895)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Moreno",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 1900",new Location(BigDecimal.valueOf(-37.997960),BigDecimal.valueOf(-57.554263)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Belgrano",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 1800",new Location(BigDecimal.valueOf(-37.997194),BigDecimal.valueOf(-57.553623)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Rivadavia",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 1700",new Location(BigDecimal.valueOf(-37.996395),BigDecimal.valueOf(-57.552932)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "San Martin",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia, Av. Pedro Luro",new Location(BigDecimal.valueOf(-37.995545),BigDecimal.valueOf(-57.552259)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "Av. Pedro Luro",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 1500",new Location(BigDecimal.valueOf(-37.994681),BigDecimal.valueOf(-57.551600)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "25 de Mayo",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 1400",new Location(BigDecimal.valueOf(-37.993883),BigDecimal.valueOf(-57.550930)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "9 de Julio",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 1300",new Location(BigDecimal.valueOf(-37.993094),BigDecimal.valueOf(-57.550322)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "3 de Febrero",false));
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Av. Independencia 1200",new Location(BigDecimal.valueOf(-37.992316),BigDecimal.valueOf(-57.549679)),true,new TrafficLight("Av. Independencia", "Av. Indepencia", true), new TrafficLight("Av. Independencia", "11 de Septiembre",false));
        UMC.devices.put(tf.getId(),tf);
        ...
        UMC.devices.put(tf.getId(),tf);
        tf = new TrafficLightController("Rivadavia 2800",new Location(BigDecimal.valueOf(-37.999231),BigDecimal.valueOf(-57.549566)),true,new TrafficLight("Rivadavia", "Rivadaviamodified", true), new TrafficLight("Rivadavia", "Bartolome Mitre",false));
        UMC.devices.put(tf.getId(),tf);
        ...
        UMC.serializeAllDevices("C:/Users/PC/Downloads/Urban-Monitoring-Center-view-DB (2)/Urban-Monitoring-Center-view-DB/src/main/resources/devices.ser");
    }

    public static void Initialize(){
        UrbanMonitoringCenter UMC = getUrbanMonitoringCenter();
        UMC.deserializeAllDevices("C:/Users/PC/Downloads/Urban-Monitoring-Center-view-DB (2)/Urban-Monitoring-Center-view-DB/src/main/resources/devices.ser");
    ...
    public void startSimulations() {
        ...
        if (!independenceTrafficLights.isEmpty()) {
            GreenWaveManager independenceWaveManager = new GreenWaveManager(independenceTrafficLights);
            new Thread(independenceWaveManager).start();
        }
        ...
        if (!rivadaviaTrafficLights.isEmpty()) {
            GreenWaveManager rivadaviaWaveManager = new GreenWaveManager(rivadaviaTrafficLights);
            new Thread(rivadaviaWaveManager).start();
        }
    }
